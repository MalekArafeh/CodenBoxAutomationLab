...
public class AppTest {
	...
	public void SelectTest() throws InterruptedException {
		...
		List<WebElement> option=driver.findElements(By.cssSelector("#dropdown-class-example>option"));
		int options=rand.nextInt(1,option.size());
		System.out.println(options);
		
		
		WebElement selected=driver.findElement(By.id("dropdown-class-example"));
		Select myselect=new Select(selected);
		
		myselect.selectByIndex(options);
